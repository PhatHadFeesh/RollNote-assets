...
`public/assets/cameras/lomography-experimental-review-20260826/`

No remote or app restoration is required. Rejected source/candidate files remain in `rejected/` until the user completes review.
