...
`public/assets/cameras/lomography-instant-family-review-20260826/`

No remote or app restoration is required. Rejected references and candidates remain in `rejected/` until the user completes review.
