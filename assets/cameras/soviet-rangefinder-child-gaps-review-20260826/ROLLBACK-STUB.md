...
- To discard the batch, remove only
  `public/assets/cameras/soviet-rangefinder-child-gaps-review-20260826/`.
- The neighboring FED 3, Zorki 4, and Chaika II review batch is independent and
  must not be removed with this directory.
