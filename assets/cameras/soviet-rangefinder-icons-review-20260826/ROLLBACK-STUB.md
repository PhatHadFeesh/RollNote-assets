...
`public/assets/cameras/soviet-rangefinder-icons-review-20260826/`

No remote or App restoration is required. After approval only, upload selected
finals to `RollNote-assets`, use GitHub Pages URLs for App mappings, preserve
previous mappings in `imageStub`, and record exact rollback instructions.
